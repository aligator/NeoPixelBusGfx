 ...
 * making use of NeoPixelBus.
 */
template <typename T_COLOR_FEATURE, typename T_METHOD>
class NeoPixelBusGfx : public Adafruit_GFX,
...
public:
  ...
  NeoPixelBusGfx(int w, int h, uint8_t pin)
      : Adafruit_GFX(w, h), NeoPixelBus<T_COLOR_FEATURE, T_METHOD>(w * h, pin),
  ...
  NeoPixelBusGfx(int w, int h, uint8_t pinClock, uint8_t pinData)
      : Adafruit_GFX(w, h), NeoPixelBus<T_COLOR_FEATURE, T_METHOD>(
                                w * h, pinClock, pinData),
        neoGfx(NeoGfx<T_COLOR_FEATURE, T_METHOD,
                      NeoPixelBus<T_COLOR_FEATURE, T_METHOD>>(w, h, this)) {}

  NeoPixelBusGfx(int w, int h)
      : Adafruit_GFX(w, h), NeoPixelBus<T_COLOR_FEATURE, T_METHOD>(w * h),
        neoGfx(NeoGfx<T_COLOR_FEATURE, T_METHOD,
                      NeoPixelBus<T_COLOR_FEATURE, T_METHOD>>(w, h, this)) {}

protected:
  NeoGfx<T_COLOR_FEATURE, T_METHOD, NeoPixelBus<T_COLOR_FEATURE, T_METHOD>>
      neoGfx;
...
public:
  ...
  static uint32_t expandColor(uint16_t color) {
    return NeoGfx<T_COLOR_FEATURE, T_METHOD,
                  NeoPixelBus<T_COLOR_FEATURE, T_METHOD>>::expandColor(color);
  }
};
